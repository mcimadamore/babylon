...
public class SuperTest extends SuperClass implements SuperInterface {
    ...
    @IR("""
            func @"superClassFieldAccess" (%0 : java.type:"SuperTest")java.type:"void" -> {
                ...
                %4 : java.type:"int" = field.assign %0 %3 @java.ref:"SuperClass::f:int";
                %5 : java.type:"int" = field.load %0 @java.ref:"SuperClass::f:int";
                %6 : java.type:"int" = var.assign %2 %5;
                %7 : java.type:"int" = constant @1;
                %8 : java.type:"int" = field.assign %0 %7 @java.ref:"SuperClass::f:int";
                %9 : java.type:"int" = field.load @java.ref:"SuperClass::sf:int";
                %10 : java.type:"int" = var.assign %2 %9;
                %11 : java.type:"int" = constant @1;
                %12 : java.type:"int" = field.assign %11 @java.ref:"SuperClass::sf:int";
                %13 : java.type:"int" = field.load @java.ref:"SuperClass::sf:int";
                %14 : java.type:"int" = var.assign %2 %13;
                %15 : java.type:"int" = constant @1;
                %16 : java.type:"int" = field.assign %15 @java.ref:"SuperClass::sf:int";
                return;
            };
            """)
