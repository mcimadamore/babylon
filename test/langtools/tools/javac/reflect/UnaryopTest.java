...
public class UnaryopTest {
    ...
    @IR("""
            func @"test6" (%0 : java.type:"byte")java.type:"void" -> {
                ...
                %3 : java.type:"byte" = var.update %1 %2 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="POSTINC";
                %4 : java.type:"byte" = var.load %1;
                %5 : java.type:"byte" = var.update %1 %4 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="POSTDEC";
                %6 : java.type:"byte" = var.load %1;
                %7 : java.type:"byte" = var.update %1 %6 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="PREINC";
                %8 : java.type:"byte" = var.load %1;
                %9 : java.type:"byte" = var.update %1 %8 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="PREDEC";
                return;
            };
            """)
    @Reflect
    ...
    @IR("""
            func @"test7" (%0 : java.type:"short")java.type:"void" -> {
                ...
                %3 : java.type:"short" = var.update %1 %2 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="POSTINC";
                %4 : java.type:"short" = var.load %1;
                %5 : java.type:"short" = var.update %1 %4 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="POSTDEC";
                %6 : java.type:"short" = var.load %1;
                %7 : java.type:"short" = var.update %1 %6 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="PREINC";
                %8 : java.type:"short" = var.load %1;
                %9 : java.type:"short" = var.update %1 %8 @operator.type=func<java.type:"int", java.type:"int", java.type:"int"> @update.kind="PREDEC";
                return;
            };
            """)
    @Reflect
